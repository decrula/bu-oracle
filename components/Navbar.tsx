...
const Navbar = () => (
  <nav className="fixed top-0 w-full z-50 glass-nav flex justify-between items-center px-6 md:px-12 py-6">
    ...
    <Link href="/checkout" className="bg-tertiary text-on-tertiary px-6 py-2 rounded-full font-sans text-[11px] uppercase tracking-widest font-bold hover:brightness-110 transition-all active:scale-95">
      Decode My Dream
    </Link>
  </nav>
);
